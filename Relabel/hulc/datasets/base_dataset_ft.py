...
class BaseDataset(Dataset):
    ...
    def __init__(
        ...
        ann_file = 'hulc/dataset/task_ABC_D/training/select_mdetr/auto_lang_ann.npy'
    ...
    def _get_sequences(self, idx: int) -> Dict:
        ...
        seq_lang = process_language(episode, self.transforms, self.with_lang, self.ann_dict)
    ...
    def __len__(self) -> int:
        ...
        Returns:
            Size of the dataset.
        """
        return len(self.ep_start_end_ids)
