...
def get_all_checkpoints(experiment_folder: Path) -> List:
    if experiment_folder.is_dir():
        ...
        print(checkpoint_folder, checkpoint_folder.is_dir())
...
def save_executed_code() -> None:
    ...
    print(os.getcwd())
    shutil.copytree(
        os.path.join(hydra.utils.get_original_cwd(), "hulc"),
        os.path.join(hydra.utils.get_original_cwd(), f"{os.getcwd()}/code/hulc"),
    )
