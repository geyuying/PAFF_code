...
#import hulc.models.hulc_mdetr_goal as models_m
...
def train(cfg: DictConfig) -> None:
    ...
    if chk is not None:
        ...
        ckpt_path = 'runs/2022-10-30/16-14-16/saved_models/epoch=5.ckpt'        
        model.load_state_dict(torch.load(ckpt_path, map_location='cpu')['state_dict'], True)
