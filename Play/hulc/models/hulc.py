...
class Hulc(pl.LightningModule):
    ...
    def configure_optimizers(self):
        ...
        #for name, param in self.named_parameters():
            #if 'action_decoder.' in name or 'plan_proposal.' in name or 'plan_recognition.' in name or 'rgb_static_encoder.fc' in name or 'rgb_gripper_encoder.fc' in name:
        #    if 'action_decoder.' in name or 'rgb_static_encoder.fc' in name or 'rgb_gripper_encoder.fc' in name:
        #         param_encoder.append(param)
        #         print(name)
        #optimizer = hydra.utils.instantiate(self.optimizer_config, params=param_encoder)
